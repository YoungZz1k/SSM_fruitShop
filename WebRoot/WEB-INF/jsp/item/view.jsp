    ...
    <div class="left_yh" style="width: 350px;height: 420px;">
        ...
        <div id="preview">
            ...
            <div id=spec-list" style="margin-top: 5px;">
                <ul class="list-h">
                    <li><img src="${obj.url2}" height="85" width="87"></li>
                    <li><img src="${obj.url3}" height="85" width="88"></li>
                    <li><img src="${obj.url4}" height="85" width="87"></li>
                    <li><img src="${obj.url5}" height="85" width="88"></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="width100 hidden_yh">
            ...
            <div id="spPj">
                <div class="width100 hidden_yh" style="padding-bottom: 20px;border-bottom: 1px dashed #ddd; margin-bottom: 10px;">
                    <c:forEach items="${obj.comments}" var="data" varStatus="l">
                        <div style="width: 790px;float: right;overflow:hidden;margin-top: 20px;">
                            <img src="${ctx}/resource/user/images/mrtx.png" style="width: 40px;height: 40px;border-radius: 50%;float: left;border:1px solid #ddd;margin-top: 20px;margin-right: 30px;">
