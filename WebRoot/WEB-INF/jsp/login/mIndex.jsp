...
<body style="background-color: #f2f9fd">
    <div class="header bg-main">
        ...
        <div class="head-l">
            ...
            <a class="button button-little bg-red" href="mExit">
    ...
    <ul class="bread">
        <li><a href="${ctx}/itemCategory/statistics" target="right" class="icon-home">首页</a> </li>
    </ul>
    <div class="admin">
        <iframe scrolling="auto" rameborder="0" src="${ctx}/itemCategory/statistics" name="right" width="100%" height="100%"></iframe>
    </div>
</body>
</html>