...
<!--导航条#dd4545-->
<div class="width100" style="height: 45px;background:#00aa00;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        <!--列表导航-->
        <div class="left_yh Selected" style="width: 230px;height: 45px;background: #00aa00" id="hiddenShow">
            <!--头部的图标-->
            ...
            <!--导航展开部分-->
            <div class="downSlide" style="background: #00aa00" >
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2"  style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px; ">
        <ul>
            <li><img src="${ctx}/resource/images/1.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/2.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/3.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/4.jpg" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
...
<!--折扣果蔬-->
<div class="width1200 center_yh hidden_yh" style="background:#00aa00">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #f0ad4e; margin-top: 20px;">
        <font class="left_yh font20">折扣果蔬</font>
    </div>
        ...
        <div class="normalPic">
            <c:forEach items="${zks}" var="data" varStatus="l">
                <a href="${ctx}/item/view?id=${data.id}">
                    ...
                    <img src="${data.url1}" width="200" height="170" alt="" style="margin:0 auto">
                </a>
            </c:forEach>
        </div>
    </div>
...
<div class="width1200 center_yh hidden_yh" style="background: #00aa00">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #f0ad4e; margin-top: 20px;">
        <font class="left_yh font20">热门果蔬</font>
    </div>
    <div class="width100 hidden_yh" style="height: 480px;">
        <div class="normalPic">
