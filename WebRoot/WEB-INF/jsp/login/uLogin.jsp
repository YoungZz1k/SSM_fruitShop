...
<body>
<div class="width100 hidden_yh" style="height: 573px;background: url('${ctx}/resource/user/images/login2.jpg') no-repeat center;position: relative;top: 120px;">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <div class="right_yh bj_fff"  style="width:408px;height: 438px;position: absolute;top:80px;right: 180px;">
