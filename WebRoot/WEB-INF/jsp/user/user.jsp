        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    <a class="button border-blue" href="${ctx}/user/update?id=${data.id}"><span class="icon-edit">修改该用户信息</span> </a>
                    <a class="button border-red" href="${ctx}/user/delete?id=${data.id}"><span class="icon-trash-o">删除此用户</span> </a>
                </div>
            </td>
        </tr>
    </c:forEach>
